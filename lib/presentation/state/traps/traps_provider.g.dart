...
@ProviderFor(relatedTraps)
final relatedTrapsProvider = RelatedTrapsFamily._();

final class RelatedTrapsProvider
    extends $FunctionalProvider<List<ChessTrap>, List<ChessTrap>, List<ChessTrap>>
    with $Provider<List<ChessTrap>> {
  RelatedTrapsProvider._({
    required RelatedTrapsFamily super.from,
    required int super.argument,
  }) : super(
         retry: null,
         name: r'relatedTrapsProvider',
         isAutoDispose: true,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$relatedTrapsHash();

  @override
  String toString() {
    return r'relatedTrapsProvider'
        ''
        '($argument)';
  }
  ...
  List<ChessTrap> create(Ref ref) {
    ...
    return relatedTraps(ref, argument);
  }
  ...
  bool operator ==(Object other) {
    return other is RelatedTrapsProvider && other.argument == argument;
  }
...
String _$relatedTrapsHash() => r'0000000000000000000000000000000000000000';

final class RelatedTrapsFamily extends $Family
    with $FunctionalFamilyOverride<List<ChessTrap>, int> {
  RelatedTrapsFamily._()
    : super(
        retry: null,
        name: r'relatedTrapsProvider',
        dependencies: null,
  ...
  RelatedTrapsProvider call(int trapId) =>
      RelatedTrapsProvider._(argument: trapId, from: this);

  @override
  String toString() => r'relatedTrapsProvider';
}
